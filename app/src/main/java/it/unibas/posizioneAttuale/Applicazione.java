package it.unibas.posizioneAttuale;
...
import it.unibas.posizioneAttuale.Controllo.ControlloVistaFileDisponibili;
import it.unibas.posizioneAttuale.Controllo.ControlloVistaPrincipale;
import it.unibas.posizioneAttuale.modello.Modello;
import it.unibas.posizioneAttuale.modello.ModelloPersistente;
...
public class Applicazione extends Application {
    ...
    private ControlloVistaPrincipale controlloVistaPrincipale = new ControlloVistaPrincipale();
    private ControlloVistaFileDisponibili controlloVistaFileDisponibili = new ControlloVistaFileDisponibili();




    public ControlloVistaFileDisponibili getControlloVistaFileDisponibili() {
        return controlloVistaFileDisponibili;
    }
